...
export const projects: PortfolioProject[] = [
	{
		...
		title: "Baseline Web",
		description:
			"A no-build, standards-first microsite demonstrating semantic HTML, responsive CSS, and progressive enhancement.",
		...
		ogImage: "/images/og/baseline-web.png",
		screenshots: {
			light: [
	...
	},
	{
		...
		ogImage: "/images/og/task-ledger.png",
		screenshots: {
			light: [
	...
	},
	{
		...
		why: "Demonstrate routing, CRUD APIs, JWT auth, and shared types in a lightweight full-stack monorepo.",
		stack:
		...
		ogImage: "/images/og/task-manager.png",
		screenshots: {
			light: [
	...
	},
	{
		...
		why: "Demonstrate practical, real-world delivery: shipping and maintaining a client-facing site plus day-to-day business tooling updates.",
	...
	},
	{
		...
		ogImage: "/images/og/note-manager.png",
		screenshots: {
			light: [
				"/images/screenshots/notemanager-overview.webp",
				"/images/screenshots/notemanager-editor.webp",
				"/images/screenshots/notemanager-dashboard.webp",
				"/images/screenshots/notemanager-viewer.webp",
			],
			dark: [
				"/images/screenshots/notemanager-overview-dark.webp",
				"/images/screenshots/notemanager-editor-dark.webp",
				"/images/screenshots/notemanager-dashboard-dark.webp",
				"/images/screenshots/notemanager-viewer-dark.webp",
			],
		},
	},
	{
		...
		description:
			"Interactive dashboard for tracking currencies, expenses, and investments.",
	...
	},
	{
		...
		ogImage: "",
		screenshots: {
			light: ["https://placehold.co/400x225@2x.png"],
			dark: ["https://placehold.co/400x225@2x.png"],
		},
	},
	{
		...
		description:
			"Reusable full-stack starter kit for authentication and dashboard apps.",
	...
	},
	{
		...
		description:
			"Small multi-tenant SaaS with authentication and CRUD functionality.",
